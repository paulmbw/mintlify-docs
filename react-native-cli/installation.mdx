...
description: "Learn how to install and set up your Launchtoday React Native project"
---
...
<Warning>
  While simulators and emulators are useful during development, it is strongly recommended to test your app on **physical devices** for both iOS and Android. Physical devices provide a more accurate testing environment, especially for features like payments and in-app purchases. Some libraries, such as RevenueCat, only work correctly on physical devices.
</Warning>
...
<img
  src="/images/launchtoday.jpg"
  alt="Application Launch Screen"
  style={{
    borderRadius: "10px",
    maxHeight: "450px",
  }}
