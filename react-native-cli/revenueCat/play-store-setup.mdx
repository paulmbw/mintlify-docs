...
Navigate to the Play Console and select your app. In the left sidebar, find "Monetization setup" and then "Products". Click the "Create product" button to begin setting up a new in-app purchase.

When creating the product, you'll need to choose between:

- One-time products (consumable or non-consumable items)
- Subscription products (recurring payments)

For one-time products, follow these configuration steps:
...
2. **Product Details**: Configure the following:
   ...
   - Name: A clear, user-facing title
   - Description: Detailed explanation of what users get
   - Price: Base price in your primary currency
   - Local pricing: Adjust prices for different regions

3. **Status**: Set the product as active or inactive
