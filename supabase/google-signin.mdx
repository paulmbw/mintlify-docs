...
1. Navigate to your Supabase dashboard's Authentication > Providers > Google section
2. Enter the Client ID and Client Secret obtained from Google Cloud Console
